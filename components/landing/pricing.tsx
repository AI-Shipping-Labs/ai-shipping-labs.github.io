...
const tiers = [
  {
    ...
    description: "Support the newsletter and get access to Alexey's written thinking and recorded content.",
    priceMonthly: 10,
    priceAnnual: 100,
    ...
    features: [
      ...
      { text: "Direct interaction with Alexey", included: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Join live streams with Alexey", included: true },
